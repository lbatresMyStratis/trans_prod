...
module.exports = {
    ...
    addDataWebImporterAMEX: async function (user, pass, url_actived, url_base, id_hiearchi, pathFile, flag) {

       var id_hiearchi =  "5237260000000026177";
        try {
            ...
            await page.evaluate(() => {
                document.querySelector('select[id="webImporter"] option:nth-child(8)').selected = true;  // fix position web list
            });
